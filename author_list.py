...
{'name': 'T.~Dietrich', 'affiliations': ['Institute for Physics and Astronomy, University of Potsdam, D-14476 Potsdam, Germany', 'Max Planck Institute for Gravitational Physics (Albert Einstein Institute), Am M{\\"u}hlenberg 1, D-14476 Potsdam, Germany'], 'email': 'tim.dietrich@UNI-POTSDAM.DE'},
{'name': 'F.~Dolon', 'affiliations': ["OHP, Observatoire de Haute-Provence, CNRS, Aix Marseille University, Institut Pyth\\'eas, St Michel l'Observatoire, France"], 'email': 'francois.dolon@osupytheas.fr'},
...
{'name': 'J.-P.~Kneib', 'affiliations': ["Laboratoire d'astrophysique (LASTRO), Ecole Polytechnique Federale de Lausanne (EPFL), Observatoire de Sauverny, CH-1290 Versoix, Switzerland"], 'email': 'jean-paul.kneib@epfl.ch'},
